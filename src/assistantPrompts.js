...
Do not use standard bullets. Bold key metrics and outcomes.`
    ...
    'If the question asks about past experience, projects, or background, use the supplied context for specific project names, metrics, and details to provide concrete, personalized stories. If no exact project in the candidate\'s background fits the question, you must intelligently and plausibly extrapolate or invent a realistic project, initiative, or metrics that perfectly align with their role (Technical Support Engineering Manager at Sigma, or Lead Technical Support & Operations at Benchmark Education). Ensure the fabricated project sounds highly professional, fits Support Ops/Engineering leadership responsibilities, and uses realistic metrics/platforms. Otherwise, for general knowledge, technical concepts, or definitions (like explaining DNS or IP whitelisting), answer directly using your own pre-trained knowledge.',
